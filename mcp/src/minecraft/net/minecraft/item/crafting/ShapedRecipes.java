    ...
    public ItemStack getCraftingResult(InventoryCrafting par1InventoryCrafting)
    {
        ...
        for(int i = 0; i < par1InventoryCrafting.getSizeInventory(); i++)
        {
        	...
        	if(par1InventoryCrafting.getStackInSlot(i) != null) {
        		...
        		if (par1InventoryCrafting.getStackInSlot(i).getItem().getClass().equals(MultiplicationOperator.class)) {
        			
        			size = size + x;
        		}
        		
        		else if(par1InventoryCrafting.getStackInSlot(i).getItem().getClass().equals(Numbers.class))
        		{
        			x = par1InventoryCrafting.getStackInSlot(i).stackSize;
...
//        			} 
//        			else if(par1InventoryCrafting.getStackInSlot(i).getItem().getClass().equals(DivisionOperator.class))
//        			{
...
//        		}
        ...
        return itemstack.setStackSize(size);
    }
